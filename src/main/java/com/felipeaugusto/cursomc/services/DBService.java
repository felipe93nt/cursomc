...
import com.felipeaugusto.cursomc.domain.Estado;
...
import com.felipeaugusto.cursomc.domain.PagamentoComCartao;
...
import com.felipeaugusto.cursomc.repositories.CidadeRepository;
...
import com.felipeaugusto.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void InstantiateDevDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Felipe Augusto", "felipe.93nt@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA,pe.encode("Spring2020"));

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "Ana.C@gmail.com", "31628382740", TipoCliente.PESSOAFISICA,pe.encode("123"));
